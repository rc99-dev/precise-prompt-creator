...
export const ALL_PAGES = [
  ...
  { key: 'historico-produto', label: 'Histórico por Produto' },
  { key: 'analise-consumo', label: 'Análise de Consumo' },
  { key: 'comparativo-financeiro', label: 'Comparativo Financeiro' },
...
const defaultPermissions: Record<string, AppRole[]> = {
  ...
  'historico-produto': ['comprador', 'aprovador', 'estoquista', 'financeiro', 'master'],
  'analise-consumo': ['comprador', 'aprovador', 'estoquista', 'financeiro', 'master'],
  'comparativo-financeiro': ['comprador', 'aprovador', 'financeiro', 'master'],
